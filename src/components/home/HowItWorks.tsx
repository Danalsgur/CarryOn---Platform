    ...
    <section className="py-16 bg-surface">
      ...
      <div className="max-w-5xl mx-auto grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {steps.map((step, index) => (
          <div
            key={index}
            className="bg-brand-light/20 rounded-layout p-6 text-center shadow-card hover:shadow-lg transition-shadow duration-200 space-y-4"
          >
      ...
      <div className="mt-20">
        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6 text-center">
          <div className="bg-surface p-6 rounded-layout shadow-card border border-gray-200 space-y-4">
            <h4 className="text-lg font-semibold text-brand">🛍️ 바이어 (Buyer)</h4>
          ...
          <div className="bg-surface p-6 rounded-layout shadow-card border border-gray-200 space-y-4">
            <h4 className="text-lg font-semibold text-brand">✈️ 캐리어 (Carrier)</h4>
            <ul className="text-text-secondary text-sm space-y-2">
